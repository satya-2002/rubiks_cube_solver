...
private:
    ...
    void rotateFace(int ind) {
        ...
        char temp = cube[getIndex(ind, 0, 0)];
        cube[getIndex(ind, 0, 0)] = cube[getIndex(ind, 2, 0)];
        cube[getIndex(ind, 2, 0)] = cube[getIndex(ind, 2, 2)];
        cube[getIndex(ind, 2, 2)] = cube[getIndex(ind, 0, 2)];
        cube[getIndex(ind, 0, 2)] = temp;

        temp = cube[getIndex(ind, 0, 1)];
        cube[getIndex(ind, 0, 1)] = cube[getIndex(ind, 1, 0)];
        cube[getIndex(ind, 1, 0)] = cube[getIndex(ind, 2, 1)];
        cube[getIndex(ind, 2, 1)] = cube[getIndex(ind, 1, 2)];
        cube[getIndex(ind, 1, 2)] = temp;
